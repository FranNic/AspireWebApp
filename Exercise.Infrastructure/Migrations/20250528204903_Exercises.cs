    ...
    public partial class Exercises : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivationLevels", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MuscleActivations", x => new { x.ExerciseId, x.MuscleId });
                    table.ForeignKey(
                        name: "FK_MuscleActivations_ActivationLevels_ActivationLevelId",
                        column: x => x.ActivationLevelId,
                        principalTable: "ActivationLevels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MuscleActivations_Exercises_ExerciseId",
                        column: x => x.ExerciseId,
                        principalTable: "Exercises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MuscleActivations_Muscles_MuscleId",
                        column: x => x.MuscleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sets_Workout_ExerciseId",
                        column: x => x.ExerciseId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MuscleActivations_ActivationLevelId",
                table: "MuscleActivations",
                column: "ActivationLevelId");
